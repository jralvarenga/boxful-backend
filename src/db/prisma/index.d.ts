...
export namespace Prisma {
  ...
  */
   ...
   * UserCountOutputType without action
   */
  export type UserCountOutputTypeCountOrderArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
   ...
   * OrderCountOutputType without action
   */
  export type OrderCountOutputTypeCountProductArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
  ...
  > extends Prisma.PrismaPromise<T> {
    ...
    user<T extends UserDefaultArgs<ExtArgs> = {}>(
      ...
      GlobalOmitOptions
    >
    Product<T extends Order$ProductArgs<ExtArgs> = {}>(
      args?: Subset<T, Order$ProductArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      | $Result.GetResult<
  ...
  export type OrderUpdateOneRequiredWithoutProductNestedInput = {
    ...
    update?: XOR<
      XOR<
        OrderUpdateToOneWithWhereWithoutProductInput,
        OrderUpdateWithoutProductInput
      >,
      OrderUncheckedUpdateWithoutProductInput
    >
  }
